...
class Message(models.Model):
    ...
    sender_deleted_at = models.DateTimeField(_("Sender deleted at"), null=True, blank=True, db_index=True)
    recipient_deleted_at = models.DateTimeField(_("Recipient deleted at"), null=True, blank=True, db_index=True)
    ...
    def mark_deleted(self, by_user):
        if self.sender == by_user:
            self.sender_deleted_at = datetime.now()
        elif self.recipient == by_user:
            self.recipient_deleted_at = datetime.now()
        self.save()
