...
class MessageAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        if notification:
            ...
            #if obj.sender:
            #    notification.send([obj.sender], sender_label, {'message': obj,}, no_django_message=True)
        ...
        for user in recipients:
            ...
            if notification:
                ...
                notification.send([user], recipients_label, {'message' : obj,}, no_django_message=True)
